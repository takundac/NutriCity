...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:53909/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:53909/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "NutriCity";
        ...
        using (NutriCity.Logic.ShoppingCartActions myCartOrders = new NutriCity.Logic.ShoppingCartActions())
        {
