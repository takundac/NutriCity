...
namespace NutriCity.Logic
{
    public class ShoppingCartActions : IDisposable
    {
        ...
        public decimal GetTotal()
        {
            ...
            //for each of those products in the cart.
        ...
        {
            using (var db = new NutriCity.Models.ProductContext())
            {
                try
                {
        ...
        {
            using (var _db = new NutriCity.Models.ProductContext())
            {
                try
                {
